...
import { StaffMemberQuery } from '../lib/queries/staffMember'
  ...
  render () {
    ...
    return (
      <Layout>
        ...
        <Query
          query={StaffMemberQuery('staffMembers')}
...
export default compose(withRoot, withData)(withStyles(styles)(StaffMember))
